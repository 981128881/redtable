<template>
	<view style="margin: 32rpx;">
		...
		<u-row>
			<view class="row-top">
				<u-col span="12" align="center">
					<u--image :showLoading="true" :src="banner" width="686rpx" height="184rpx" radius="8rpx">
					</u--image>
				</u-col>
			</view>
		</u-row>
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-travel">
					<view v-for="(item, index) in tour" :key="index" @click="toSpecial(item)">
						<view class="swpierBox">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-buy">
					<view v-for="(item, index) in instance" :key="index" @click="toStore(item)">
						<view class="swpierBox">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-buy">
					<view v-for="(item, index) in street" :key="index" @click="toStore(item)">
						<view class="swpierBox">
							<view class="swpierBox-view-buy">
								<image :src="item.imgUrl"></image>
								<view class="card">
									...
									<view class="discounts">
										<span>优惠</span>
										<span>打折</span>
										<span class="safe">{{item.award}}</span>
									</view>
								</view>
							</view>
						</view>
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-buy">
					<view v-for="(item, index) in best" :key="index" @click="toStore(item)">
						<view class="swpierBox">
							<view class="swpierBox-view-buy">
								<image :src="item.imgUrl"></image>
								<view class="card">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-cheap">
					<view v-for="(item, index) in good_value" :key="index" @click="toStore(item)">
						<view class="swpierBox">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-travel">
					<view v-for="(item, index) in city" :key="index" @click="checkedCity(item)">
						<view class="swpierBox">
							<view class="swpierBox-view-travel">
								<image :src="item.imgUrl"></image>
								<view class="card">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-travel">
					<view v-for="(item, index) in district" :key="index" @click="checkedDistrict(item)">
						<view class="swpierBox">
							<view class="swpierBox-view-travel">
								<image :src="item.imgUrl"></image>
								<view class="card">
		...
		<u-row>
			<view style="margin-top: 32rpx;width: 720rpx;">
				<u-scroll-list :indicator="false" class="swipe swipe-travel">
					<view v-for="(item, index) in category" :key="index" @click="toSpecial(item)">
						<view class="swpierBox">
							<view class="swpierBox-view-travel">
								<image :src="item.imgUrl"></image>
								<view class="card">
			...
			<u-row>
				<view style="margin-top: 32rpx;width: 720rpx;">
					<u-scroll-list :indicator="false" class="swipe swipe-place">
						<view v-for="(store, index) in categories.store" :key="index" @click="toStore(store)">
							<view class="swpierBox">
								<view class="swpierBox-view-place">
									<image :src="store.image"></image>
									<view class="card">
										<h3 class="h3">{{store.storeName}}({{store.branchName}})</h3>
										<view class="star">
											<u-icon name="star-fill" color="#FF4A52" size="36rpx"></u-icon>
											<span class="score">{{store.score}}({{store.count}})</span>
										</view>
										<span class="food">{{store.menu}}</span>
										<span class="food-info">{{store.label}}</span>
										<h3 class="price">
											{{store.price}}
									...
									<view class="heart" @click.stop="collect(i,index)">
										<u-icon name="heart" color="#FFFFFF" size="40rpx" v-if="store.is_collect == 0"></u-icon>
										<u-icon name="heart-fill" color="#FF4A52" size="40rpx" v-if="store.is_collect == 1"></u-icon>
									</view>
								</view>
							</view>
						</view>
				...
				uni.request({
					...
					success: res => {
						...
						themes.map((item, index) => {
							newThemes.push({
								url: item['zh-Hans'],
								link: '/pages/special/index?s_commercial_area_id=' + item[
										'com_area_id'] +
									'&s_must_eat_id=' + item['musteat_id']
							})
						})
						flex.map((item, index) => {
							newFlex.push({
						...
						tour.map((item, index) => {
							newTour.push({
								...
								link: '/pages/special/index?s_commercial_area_id=' + item[
										'com_area_id'] +
									'&s_must_eat_id=' + item['must_eat_id']
							})
						})
